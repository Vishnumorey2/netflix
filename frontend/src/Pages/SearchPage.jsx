...
const SearchPage = () => {
    ...
    const handleTabClick = (tab) => {
        setActiveTab(tab);
		tab === "movie" ? setContent("movies") : setContent("tv");
		setResults([]);
    }
    ...
    <div className='bg-black min-h-screen text-white' >
        ...
        <div className='container mx-auto px-4 py-8'>
            <div className="flex justify-center gap-3 mb-4" >
                <button className={`py-2 px-4 rounded ${activeTab === "movies" ? "bg-red-600" : "bg-gray-800"} hover:bg-red-700`}
            ...
            <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4' >
                {results.map((result) => {
                    ...
                    return (
                        <div className="key={result.id} className='bg-gray-800 p-4 rounded'" > 
                        {activeTab === "person" ? (
